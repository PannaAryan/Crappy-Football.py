...
goalKeeper_1.shapesize(stretch_wid=5,stretch_len=0.7)
goalKeeper_1.penup()
...
goalKeeper_2.shapesize(stretch_wid=5,stretch_len=0.7)
goalKeeper_2.penup()
...
while True:
    ...
    # Top and bottom
    if football.ycor() > 290:
        football.sety(290)
        football.dy *= -1
        os.system("afplay Jump.wav&")

    elif football.ycor() < -290:
        football.sety(-290)
        football.dy *= -1
        os.system("afplay Jump.wav&")

    # Left and right
    if football.xcor() > 350:
        score_G1 += 1
        show_scores.clear()
    ...
    if football.xcor() < -340 and football.ycor() < goalKeeper_1.ycor() + 50 and football.ycor() > goalKeeper_1.ycor() - 50:
        football.dx *= -1
        os.system("afplay Jump.wav&")

    elif football.xcor() > 340 and football.ycor() < goalKeeper_2.ycor() + 50 and football.ycor() > goalKeeper_2.ycor() - 50:
        football.dx *= -1
        os.system("afplay Jump.wav&")
